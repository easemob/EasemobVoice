...
//        getWindow().getDecorView().getViewTreeObserver().addOnGlobalLayoutListener(this::detectKeyboardLayout);
    }

    protected void stopDetectKeyboard() {
//        getWindow().getDecorView().getViewTreeObserver().removeOnGlobalLayoutListener(this::detectKeyboardLayout);
    }
    ...
    protected void showInputMethodWithView(View view) {
        mInputMethodManager.showSoftInput(view, 0);
    }

    protected void hideInputMethodWithView(EditText editText) {
