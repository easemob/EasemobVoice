...
public abstract class BusinessProxy implements
        ...
        RoomServiceListener, SeatServiceListener, IMServiceListener {
    ...
    public void getAdminToken() {
        mServerClient.getAdminToken(this);
    }

    public void createChatRoom(String subject, String description, String welcomeMessage,
                               int maxUserCount, List<String> members){
//        mServerClient.createChatRoom(subject,description,welcomeMessage,maxUserCount,members,this);
    }
    ...
    public void onGetAdminTokenSuccess(String token) {
        mProxyListener.onGetAdminTokenSuccess(token);
    }

    @Override
    public void onCreateChatRoomSuccess(String imRoomID) {
        mProxyListener.onCreateChatRoomSuccess(imRoomID);
    }

    @Override
    public void onImServiceFailed(int type, int code, String msg) {
        handleServiceFail(type, code, msg);
    }
}
