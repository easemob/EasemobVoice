...
//        if (timestamp != null) {
//            if (position == 0) {
//                timestamp.setText(CmosDateUtils.getTimestampStringChat(new Date(message.getMsgTime())));
...
//                    EaseUserUtils.setUserGroupNick(message.getFrom(),message.getTo(), usernickView);
//                } else {
            ...
            bubbleLayout.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (itemClickListener != null) {
                        itemClickListener.onBubbleLongClick(message,bubbleLayout,position);
                    }
                    return true;
                }
            });
