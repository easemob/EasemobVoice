...
public class UserListActionSheet extends AbstractActionSheet implements View.OnClickListener {
    ...
    private void init() {
        ...
        mUserListRecycler.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
            ...
            if (mShowInvite) {
                ...
                if (excludedIds != null) {
                    for (int i = allList.size() - 1; i >= 0; i--) {
                        ...
                        if (excludedIds.contains(info.userId) || info.userId.equals(mOwnerId)) {
                            deleteList.add(i);
                        }
                    }
                }
