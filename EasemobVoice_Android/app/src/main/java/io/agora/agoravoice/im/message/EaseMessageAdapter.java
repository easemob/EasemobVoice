...
public class EaseMessageAdapter extends BaseAdapter {
	...
	Handler handler = new Handler() {
		private void refreshList() {
			...
			EMLog.d(TAG,"当前选中的目标："+messages.length +"当前size:"+messages.length);
		...
		public void handleMessage(android.os.Message message) {
            ...
            case HANDLER_MESSAGE_SEEK_TO:
				...
				EMLog.d(TAG,"当前选中的目标："+position+"当前size:"+messages.length);
                break;
			default:
				break;
			}
	 ...
	 */
	/*public void refreshSeekTo(int position) {
		Message message = handler.obtainMessage(HANDLER_MESSAGE_SEEK_TO);
...
//            } else if (message.ext().containsKey(EaseConstant.CARD_EVENT)){
