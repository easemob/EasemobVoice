...
class AboutViewController: MaskTableViewController {
    ...
    override func viewDidLoad() {
        ...
        alValueLabel.text = "v\(AppAssistant.version)"
        sdkValueLabel.text = "v3.8.5"
        
        releaseDateValueLabel.text = "2021.09.30"
        
        uploadLogLabel.text = MineLocalizable.uploadLog()
        
        agoraLabel.text = "www.easemob.com"
    ...
    override func tableView(_ tableView: UITableView,
        ...
        case privacyItem:
            ...
            if DeviceAssistant.Language.isChinese {
                privacyURL = URL(string: "https://www.easemob.com/protocol")
            } else {
                privacyURL = URL(string: "https://www.easemob.com/protocol")
            }
        ...
        case agoraAccountItem:
            var accountURL: URL?
            if DeviceAssistant.Language.isChinese {
                accountURL = URL(string: "https://console.easemob.com/user/register")
            } else {
                accountURL = URL(string: "https://console.easemob.com/user/register")
            }
